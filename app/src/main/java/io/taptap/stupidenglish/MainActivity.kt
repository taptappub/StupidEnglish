...
//9) Группы при возвращении назад (см. телегу с Риной)
//10) Можно создать пустую карточку или поставить пробел перед словом. Не думаю, что юзеры будут такой фигнёй заниматься, да и даже если будут, то пофиг.
...
//13) Если на этом этапе нажать вне попапа, то происходит попытка отправки репорта с ошибкой
//14) Если кастомных групп несколько, то когда ты выбрал до создания слова группу Б, и сохранил новое слово в группе А, в группе Б будут отображаться вообще все слова
