package io.taptap.notify

import android.annotation.TargetApi
import android.os.Build
import androidx.core.app.NotificationCompat
import io.taptap.notify.entities.Payload
import io.taptap.notify.internal.RawNotification
import io.taptap.notify.internal.utils.Action
import io.taptap.notify.internal.utils.Errors
import io.taptap.notify.internal.utils.Experimental
import io.taptap.notify.internal.utils.NotifyScopeMarker
...
class NotifyCreator internal constructor(private val notify: Notify) {
    ...
    @Deprecated(message = "Exposes function under the incorrect API -- NotifyCreator is reserved strictly for notification construction.",
            replaceWith = ReplaceWith(
                    ...
                    "android.content.Context", "io.taptap.notify.Notify"))
